...
**Output path**: `.prp-output/prds/drafts/{kebab-case-name}-prd-opencode-{TIMESTAMP}.md`

Example: `auth-feature-prd-opencode-20260210-1430.md`
...
**File**: `.prp-output/prds/drafts/{name}-prd-opencode-{TIMESTAMP}.md` (DRAFT)
