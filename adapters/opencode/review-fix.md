...
If the input is a fix-summary artifact: STOP — "Cannot fix a fix-summary. Pass a review artifact instead (e.g., `pr-{N}-review-opencode.md` or `pr-{N}-agents-review.md`)."

**Extract PR number from filename:**

```bash
# Artifact name format: pr-{NUMBER}-*.md (e.g. pr-123-review-opencode.md)
...
```
.prp-output/reviews/pr-123-review-opencode.md   <- this tool's review
...
```
Using review artifact: pr-123-review-opencode.md
```
...
Multiple review artifacts found for PR #123:
  ...
  [1] pr-123-review-opencode.md    (this tool)     modified: 2026-02-27 14:30
