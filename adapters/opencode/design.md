...
**Output path**: `.prp-output/designs/{feature}-design-opencode-{TIMESTAMP}.md`

Example: `auth-feature-design-opencode-20260210-1430.md`
...
**File**: `.prp-output/designs/{name}-design-opencode-{TIMESTAMP}.md` (REFERENCE ONLY)
