...
8. **Archive**: `mv $ARGUMENTS .ai-workflows/plans/completed/`
9. **Output**: Status, validation summary, files changed, deviations, artifacts, PRD progress (if applicable), next steps.
