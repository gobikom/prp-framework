...
**Output path**: `.prp-output/designs/{feature}-design-thclaws-{TIMESTAMP}.md`

Example: `auth-feature-design-thclaws-20260210-1430.md`
...
**File**: `.prp-output/designs/{name}-design-thclaws-{TIMESTAMP}.md` (REFERENCE ONLY)
