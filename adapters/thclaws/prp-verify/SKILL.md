---
name: prp-verify
description: "Requirements verification — for each acceptance criterion, find evidence in the PR diff that it was implemented. Produces verify artifact for safe-merge Gate 2."
metadata:
  short-description: Verify PR implements requirements
---
...
```
/prp-verify 42
/prp-verify 42 --issue 166
/prp-verify 42 --plan .prp-output/plans/feature.plan.md
/prp-verify 42 --criteria "Gate 2 blocks agent PRs, bypass requires --reason"
```
