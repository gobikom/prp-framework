...
REVIEW_FILE=$(ls -t .prp-output/reviews/pr-${NUMBER}-review-thclaws.md 2>/dev/null | head -1)
```
...
Save aggregated review to `.prp-output/reviews/pr-{NUMBER}-review-thclaws.md` before posting to GitHub.

> **Note**: Uses `-thclaws` suffix to identify which tool produced the review and prevent overwriting reviews from other tools (each tool uses its own suffix for parallel review capability).

### Post to GitHub

| Condition | Action |
|-----------|--------|
| READY TO MERGE | `gh pr review {NUMBER} --approve --body-file .prp-output/reviews/pr-{NUMBER}-review-thclaws.md` |
| NEEDS FIXES or CRITICAL ISSUES | `gh pr review {NUMBER} --request-changes --body-file .prp-output/reviews/pr-{NUMBER}-review-thclaws.md` |
| Draft PR | `gh pr comment {NUMBER} --body-file .prp-output/reviews/pr-{NUMBER}-review-thclaws.md` (comment only — no formal review on drafts) |
...
3. Fall back to: `gh pr comment {NUMBER} --body-file .prp-output/reviews/pr-{NUMBER}-review-thclaws.md`
...
**PR**: #{NUMBER}
**Verdict**: {READY TO MERGE / NEEDS FIXES / CRITICAL ISSUES}
**Review File**: `.prp-output/reviews/pr-{NUMBER}-review-thclaws.md`
