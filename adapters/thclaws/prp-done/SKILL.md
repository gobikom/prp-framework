...
metadata:
  short-description: Close issue after all gates pass
---
...
Extract issue number from `$ARGUMENTS`. If not provided: STOP — "Issue number required. Usage: `/prp-done <issue-number>`"
