...
**Output path**: `.prp-output/prds/drafts/{kebab-case-name}-prd-thclaws-{TIMESTAMP}.md`

Example: `auth-feature-prd-thclaws-20260210-1430.md`
...
**File**: `.prp-output/prds/drafts/{name}-prd-thclaws-{TIMESTAMP}.md` (DRAFT)
