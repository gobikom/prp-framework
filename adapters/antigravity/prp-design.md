...
8. **Generate**: Save to `.prp-output/designs/{feature}-design-antigravity.md` (create dir: `mkdir -p .prp-output/designs`)

   > **Note**: `-antigravity` suffix for Antigravity design docs. Multiple tools can create designs for comparison.
...
*Generated: {timestamp} | Tool: Antigravity*
```
...
```
/prp-design .prp-output/prds/auth-prd.md
```
