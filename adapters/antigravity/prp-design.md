...
**Output path**: `.prp-output/designs/{feature}-design-antigravity-{TIMESTAMP}.md`

Example: `auth-feature-design-antigravity-20260210-1430.md`
...
**File**: `.prp-output/designs/{name}-design-antigravity-{TIMESTAMP}.md` (REFERENCE ONLY)
