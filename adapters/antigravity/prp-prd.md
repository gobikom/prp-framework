...
**Output path**: `.prp-output/prds/drafts/{kebab-case-name}-prd-antigravity-{TIMESTAMP}.md`

Example: `auth-feature-prd-antigravity-20260210-1430.md`
...
**File**: `.prp-output/prds/drafts/{name}-prd-antigravity-{TIMESTAMP}.md` (DRAFT)
