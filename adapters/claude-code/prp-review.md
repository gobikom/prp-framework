...
**CHECKPOINT**: Context file created. All passes will read from this file.
...
| Draft PR or permission fallback | `gh pr comment {NUMBER} --body-file .prp-output/reviews/pr-{NUMBER}-review-claude-code.md` |
...
```json
{"timestamp":"2026-03-14T10:30:00Z","pr_number":163,"branch":"feature/auth","verdict":"NEEDS_FIXES","total_issues":5,"critical":1,"important":2,"suggestions":2,"passes_run":["code","security","deps","docs","tests","errors","types"],"conditional_passes":["a11y"],"incremental":false,"large_pr":false,"lines_changed":342,"files_changed":8}
```
