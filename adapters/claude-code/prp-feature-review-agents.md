...
**Context File Path**: `.prp-output/reviews/feature-context-{package-name}.md`
...
**CHECKPOINT**: Context file created at `.prp-output/reviews/feature-context-{package-name}.md`
...
**code-reviewer**:
> Read context file at `.prp-output/reviews/feature-context-{pkg}.md`.
...
**Path**: `.prp-output/reviews/feature-review-{package-name}-agents-{date}.md`
...
*Report: `.prp-output/reviews/feature-review-{package-name}-agents-{date}.md`*
*Context: `.prp-output/reviews/feature-context-{package-name}.md`*
```
...
📄 **Full Report**: `.prp-output/reviews/feature-review-{pkg}-agents-{date}.md`
📋 **Context File**: `.prp-output/reviews/feature-context-{pkg}.md`
