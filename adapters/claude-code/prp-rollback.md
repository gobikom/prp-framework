...
To restore your work: `/prp-core:prp-rollback --restore`
```
...
```
/prp-core:prp-rollback                # Interactive — shows options
/prp-core:prp-rollback --soft         # Unstage only, keep files
/prp-core:prp-rollback --hard         # Full revert with stash backup
/prp-core:prp-rollback --restore      # Recover from previous rollback
```
