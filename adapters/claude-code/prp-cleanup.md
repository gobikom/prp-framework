...
```
/prp-core:prp-cleanup                           # Current branch
/prp-core:prp-cleanup feat/auth                 # Specific branch
/prp-core:prp-cleanup --all                     # All merged branches
/prp-core:prp-cleanup --all --dry-run           # Preview batch cleanup
/prp-core:prp-cleanup feat/login --dry-run      # Preview single branch
```
