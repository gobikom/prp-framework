...
If the input is a fix-summary artifact: STOP — "Cannot fix a fix-summary. Pass a review artifact instead (e.g., `pr-{N}-review-codex.md` or `pr-{N}-agents-review.md`)."

**Extract PR number from filename:**

```bash
# Artifact name format: pr-{NUMBER}-*.md (e.g. pr-123-review-codex.md)
...
```
Using review artifact: pr-123-review-codex.md
```
...
$prp-review-fix .prp-output/reviews/pr-42-review-codex.md  # By artifact path, LOOP mode
```
