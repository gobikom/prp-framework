...
**Skip this phase** if invoked as part of `{TOOL}:run-all` (detected by: `.claude/prp-run-all.state.md` exists, or `[WORKSPACE CONTEXT]` present). The orchestrator produces its own summary in Step 7.
