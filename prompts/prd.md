...
**Output path**: `.prp-output/prds/drafts/{kebab-case-name}-prd-{TOOL}-{TIMESTAMP}.md`

Example: `auth-feature-prd-{TOOL}-20260210-1430.md`
...
**File**: `.prp-output/prds/drafts/{name}-prd-{TOOL}-{TIMESTAMP}.md` (DRAFT)
